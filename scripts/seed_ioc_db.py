...
Strategy
--------
The bundled ioc_db.json is the canonical, high-precision IOC snapshot. It
ships embedded into the skillscan-security Python package via the weekly
`sync-bundled-rules` workflow and is searched on every scan. It must be:
...
IOC_DB_PATH = REPO_ROOT / "intel/ioc_db.json"
